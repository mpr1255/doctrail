...
def fix_double_encoded_utf8(text: str) -> str:
    ...
    Historically this extractor exposed ``fix_double_encoded_utf8``. The
    modern implementation consolidates several normalization steps in
    :func:`fix_mixed_encoding`.  Keep the legacy name so downstream utilities
