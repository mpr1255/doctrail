...
sql_queries:
  docs: |
    SELECT rowid, sha1 FROM documents  # Payload fetched based on input_columns!
...
# Critical Test: Append/Overwrite with --limit functionality
# THIS TEST MUST ALWAYS PASS - It has broken multiple times before
tests/test_limit_append_overwrite.py
